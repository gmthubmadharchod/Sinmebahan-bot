...
photologo = 'https://ar-hosting.pages.dev/1752942104883.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://ar-hosting.pages.dev/1752942110594.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://ar-hosting.pages.dev/1752942113175.jpg'
photozip = 'https://ar-hosting.pages.dev/1752942112328.jpg'
...
async def token_handler(client: Client, m: Message):
    ...
    editable = await m.reply_text("<b>Enter 𝐏𝐖/𝐂𝐖/𝐂𝐏 Working Token For 𝐌𝐏𝐃 𝐔𝐑𝐋 or send /d</b>\n<blockquote>If you are downloading Classplus Videos, make sure you joined @Team_Sonu1 this channel</blockquote>")
    input: Message = await bot.listen(editable.chat.id)
    token = input.text
    if token == '/d':
        cwtoken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..snDdd-PbaoC42OUhn5SJaEGxq0VzfdzO49WTmYgTx8ra_Lz66GySZykpd2SxIZCnrKR6-R10F5sUSrKATv1CDk9ruj_ltCjEkcRq8mAqAytDcEBp72-W0Z7DtGi8LdnY7Vd9Kpaf499P-y3-godolS_7ixClcYOnWxe2nSVD5C9c5HkyisrHTvf6NFAuQC_FD3TzByldbPVKK0ag1UnHRavX8MtttjshnRhv5gJs5DQWj4Ir_dkMcJ4JaVZO3z8j0OxVLjnmuaRBujT-1pavsr1CCzjTbAcBvdjUfvzEhObWfA1-Vl5Y4bUgRHhl1U-0hne4-5fF0aouyu71Y6W0eg'
...
async def feature_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942110594.jpg",
      caption=caption
    ),
    reply_markup=keyboard
  )
...
async def pin_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942105659.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
